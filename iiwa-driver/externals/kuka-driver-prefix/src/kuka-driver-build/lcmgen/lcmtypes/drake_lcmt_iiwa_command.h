 ...
 */
drake_lcmt_iiwa_command* drake_lcmt_iiwa_command_copy(const drake_lcmt_iiwa_command* to_copy);

/**
 * Destroy an instance of drake_lcmt_iiwa_command created by drake_lcmt_iiwa_command_copy()
 */
void drake_lcmt_iiwa_command_destroy(drake_lcmt_iiwa_command* to_destroy);
 ...
 */
int drake_lcmt_iiwa_command_publish(lcm_t *lcm, const char *channel, const drake_lcmt_iiwa_command *msg);
 ...
 */
drake_lcmt_iiwa_command_subscription_t* drake_lcmt_iiwa_command_subscribe(lcm_t *lcm, const char *channel, drake_lcmt_iiwa_command_handler_t handler, void *userdata);
 ...
 */
int drake_lcmt_iiwa_command_decode(const void *buf, int offset, int maxlen, drake_lcmt_iiwa_command *msg);
